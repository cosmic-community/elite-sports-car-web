        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a 
                href="https://twitter.com/elitesportscars" 
                target="_blank" 
              ...
              <a 
                href="https://www.linkedin.com/company/elitesportscars" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
              ...
              <a 
                href="https://www.facebook.com/elitesportscars" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
              ...
              <a 
                href="https://www.instagram.com/elitesportscars" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
